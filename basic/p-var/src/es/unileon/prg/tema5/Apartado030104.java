 ...
 */
    ...
    */
       public void ejercicio01() {
        ...
        // varByte   = varShort;
        // varShort  = varInt;
	//  varByte   = varShort; es incorrecta porque Byte no puede con una variable > 127
	//  varShort  = varInt; es incorrecta porque varShort no puede con una variable de 1500000
    ...
    * Arreglar los posibles errores de compilacion y explicar en el fichero LEEME.TXT los resultados    */
       public void ejercicio04() {
         ...
         double dGigante, dNormal, dMinimo, fGigante;
         float fNormal, fMinimo;
