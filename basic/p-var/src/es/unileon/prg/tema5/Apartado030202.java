 ...
 */
    ...
    */
      ...
      // Inicio modificacion
	cadena.append(" ").append(otraCadena).append(" ").append(año);
	System.out.println(cadena.toString());
	
	// length=16, 16 caracter.
	// capacity=32, String equivale a 16plus ,y + 16 numeros de los caracteres que existen.
        // Fin modificacion
      }
    ...
    */
       public void ejercicio03() {
         ...
         StringBuffer cadena=new StringBuffer("Viaje al Parnaso");
      // Modificaciones
	cadena.replace(9,16,"Castalia").delete(7,8);
	System.out.println(cadena.toString());
      }
    ...
    */
	...
	String resultado= otraCadena + cadena ;
