...
public class Partido {
	...
	public void jugar() {
		...
		while(resultado1==resultado2){
			resultado1= Math.random()*(this.getJugador1()).getPuntosATP();
			resultado2= Math.random()*(this.getJugador2()).getPuntosATP();
		}

		if(resultado1>resultado2){
			this.ganador=this.getJugador1();
			this.getJugador1().setPuntosATP((getJugador1().getPuntosATP()+1));

		}else if (resultado1<resultado2){
			this.ganador=this.getJugador2();
			this.getJugador2().setPuntosATP((getJugador2().getPuntosATP()+1));
