...
public class Apartado030101 extends Apartado {
	...
	public void ejercicio01() {
		...
		if ((alumno.obtenerNota() <5) && (alumno.obtenerNota() >= 0))
		{
			System.out.println("El alumno debe recuperar");
		}
		else if ((alumno.obtenerNota() >=5) && (alumno.obtenerNota() <= 10))
		{
			System.out.println ("El alumno esta aprobado");
		}
		else
		{
			System.out.println ("La nota no esta definida");
		}
	...
	public void ejercicio02() {
		...
		{
		System.out.println("Valor introducior introducdo incorrecto");
		}
		else{
			compruebaNota(nota);
		}
	...
	int n1, n2, aux;
	System.out.println("Introduce primer numero n1: ");
	n1=Teclado.readInteger();
	System.out.println("Introduce segundo numero n2: ");
	...
	n1=n2;
	n2=aux;
	System.out.println("como n1>n2 , intercambiar los numeros ");
	...
	private void compruebaNota(float nota)
	{
	if ((nota <5) && (nota >= 0))
		{
			System.out.println("El alumno debe recuperar");
